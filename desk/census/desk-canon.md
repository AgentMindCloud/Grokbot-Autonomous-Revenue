...
- designed_role_in_repo: Desk Canon
...
- connectors_visible: [user-GitHub-xai, user-buyer-payment-worker (visible — must never use)]
- github_write: yes
- scheduled_routines: []
- skills_saved: []
...
- drift: desk/FLEET.md bot table does not name Desk Canon (role in desk/bots/DESK-CANON.md); payment-worker MCP visible account-wide but Canon must never use it; no clock routines (correct)

## Last 7 days
- last_real_task: 2026-09-21 cite to Market CoS — hold Monday Frontier cards until Friday steal-list + named yes
- last_file_or_issue_I_wrote: desk/census/desk-canon.md
...
- write_to_repo: normally none; census only at desk/census/desk-canon.md; DECISIONS rows via CoS/human only
